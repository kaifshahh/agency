...
const Footer = () => {
  return (
    <footer className="relative w-full bg-black/10 dark:bg-white/3 backdrop-blur-md text-slate-900 dark:text-gray-300 overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-15 grid grid-cols-1 md:grid-cols-3 gap-30">
        ...
        <div className="space-y-5">
          ...
          <p className="text-slate-800 dark:text-gray-400 text-sm leading-relaxed max-w-sm">
        ...
        <div className="space-y-6">
          ...
          <ul className="grid grid-cols-2 gap-y-3 gap-x-15 text-sm">
            {[
              ...
              <li
                key={item.id}
                className="hover:text-red-700 dark:hover:text-white transition-all duration-200 cursor-pointer hover:translate-x-1"
              >
        ...
        <div className="space-y-6">
          ...
          <div className="text-sm text-slate-800 dark:text-gray-400 space-y-2">
            <p>📍Thane, Mumbai, India</p>
            <p>📧 contact@gmail.com</p>
            <p>📞 +91 9028525688</p>
          </div>
          {/* Social Icons */}
          <div className="flex gap-5 text-slate-900 dark:text-gray-400 text-xl">
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-sm text-slate-800 dark:text-gray-500 text-center md:text-left">
          ...
          <div className="flex gap-5  dark:text-gray-400 text-xl">
            <a
              href="#"
              className="text-sm text-slate-800 dark:text-gray-500 text-center md:text-left hover:underline"
            >
              Privacy Policy
            </a>
            <a
